            ...
            >
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="w-12 h-12 rounded-lg bg-amber-500/15 border border-amber-500/30 flex flex-col items-center justify-center text-amber-400 shrink-0">
                    <Scale className="w-4 h-4 text-amber-400" />
                    <span className="text-[10px] font-bold font-mono mt-0.5">{cs.year}</span>
                  </div>
                  <div>
                    <h3 className="text-sm sm:text-base font-bold text-white leading-snug">{cs.caseName}</h3>
              ...
              <div className={`accordion-content ${isExpanded ? 'block' : 'hidden'} print:!block p-5 bg-[#0c162c]/60 print:bg-white space-y-3 text-xs`}>
                <div className="bg-[#0e1a33] print:bg-gray-50 p-3.5 rounded-lg border border-slate-800 print:border-gray-300 space-y-1">
                  ...
                  <p className="text-slate-200 print:text-black leading-relaxed">{language === 'hi' ? cs.rulingSummary.hi : cs.rulingSummary.en}</p>
                </div>
