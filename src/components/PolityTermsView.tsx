          ...
          return (
            <div
              ...
              className={`p-4 rounded-xl border transition-all flex flex-col justify-between ${
                isSpecialAct
                  ? 'col-span-1 md:col-span-2 bg-gradient-to-br from-amber-950/40 via-[#0f2744] to-[#162942] border-amber-500/60 shadow-lg shadow-amber-950/30'
                  : 'bg-[#0f2744]/90 border-amber-500/20 hover:border-amber-500/40'
              }`}
            >
              <div>
                ...
                <div className="space-y-2 text-xs mt-2">
                  ...
                  <div className="bg-[#0a192f] p-2.5 rounded-lg border border-slate-800 text-[11px] text-slate-400 leading-relaxed font-sans">
              ...
              {termItem.context && (
                <div className="mt-3 pt-2 border-t border-slate-800/80 text-[11px] text-amber-300/90 flex items-center gap-1.5">
