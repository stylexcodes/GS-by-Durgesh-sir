          ...
          return (
            ...
            >
              ...
              <div
                ...
                className="p-4 cursor-pointer hover:bg-slate-100/50 flex items-center justify-between gap-3 border-b border-slate-200"
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-amber-500/10 border border-slate-300 flex items-center justify-center font-bold text-blue-900 font-cinzel text-base">
                    {sch.number}
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-2">
                  <button className="text-blue-900 hover:text-blue-900 p-1">
              ...
              <div className={`accordion-content ${isExpanded ? 'block' : 'hidden'} print:!block p-5 bg-[#f8fafc]/60 print:bg-white space-y-4`}>
                <div className="text-xs text-slate-800 print:text-black leading-relaxed bg-[#f8fafc] print:bg-gray-50 p-3 rounded-lg border border-slate-200 print:border-gray-300">
                  <span className="font-bold text-blue-900 print:text-black block mb-1">
                ...
                {sch.details && sch.details.length > 0 && (
                  <div className="space-y-2">
                    <span className="text-xs font-bold text-blue-900 print:text-black uppercase tracking-wider block">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      {sch.details.map((detail, idx) => (
                        <div
                          key={idx}
                          className="bg-[#11243e] print:bg-gray-50 p-3 rounded-lg border border-slate-200 print:border-gray-300 flex items-start gap-2.5 text-xs text-slate-800 print:text-black"
                        >
                          <CheckCircle className="w-4 h-4 text-blue-900 print:text-black shrink-0 mt-0.5 no-print" />
                          <div className="space-y-1">
                            <div>{language === 'hi' ? detail.hi : detail.en}</div>
                            <div className="text-[11px] text-slate-600 print:text-gray-700 font-sans border-t border-slate-200/80 print:border-gray-300 pt-1">
                ...
                {sch.relatedArticles && sch.relatedArticles.length > 0 && (
                  <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-slate-200 print:border-gray-300">
